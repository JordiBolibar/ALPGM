...
sc = plt.scatter(ref_areas, sim_areas_07 , s=200, alpha = 0.5, c='red', edgecolors='none', label='Ice thickness -30%')
sc = plt.scatter(ref_areas, sim_areas_13 , s=200, alpha = 0.5, edgecolors='none', label='Ice thickness + 30%')
sc = plt.scatter(ref_areas, sim_areas_1, s=200, alpha = 0.5, c='C2', edgecolors='none', label='Original ice thickness')
